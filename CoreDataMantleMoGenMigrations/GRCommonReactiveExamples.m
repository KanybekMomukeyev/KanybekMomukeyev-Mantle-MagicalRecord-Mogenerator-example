...
- (void)racSequenceExamples
{
    ...
    RACSignal *throttle3Signal = [RACSignal createSignal:^RACDisposable * (id<RACSubscriber> subscriber) {
    ...
    RACSignal *throttleMergedSignal = [RACSignal merge:@[throttleSignal, throttle2Signal, throttle3Signal]];
    ...
    [[throttleMergedSignal take:1] subscribeNext:^(NSNumber *numberValue) {
        NSLog(@"numberValue = %@",numberValue);
    }];
